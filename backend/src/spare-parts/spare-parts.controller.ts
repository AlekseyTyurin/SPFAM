...
export class SparePartsController {
    ...
    addSparePart(
        ...
        @Body('price') sparePrice: number): any {
        const generatedId = this.sparePartsService.insertSparePart(spareTitle, spareDesc, sparePrice);
        return {id: generatedId}
    }

    @Get()
    async getAllSpareParts() {
        const spareParts = await this.sparePartsService.getSpareParts();
        return spareParts;
    }
    @Get(':id')
    ...
    async updateSparePart(
        ...
        await this.sparePartsService.updateSparePart(spareId, spareTitle, spareDesc, sparPrice);
        return null;
    }
